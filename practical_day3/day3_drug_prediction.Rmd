...
author: "J. Tanevski & A. Gabor & A. V. Ponce"
date: "12.02.2021"
output:
  html_document:
    toc: yes
...
if(!requireNamespace("readr", quiely = TRUE)) install.packages("readr")
...
```{r}
IC50 <- read_csv("./data/tutorial_3/IC50_GDSC.csv") %>% rename("cell_line" = "X1")
print(IC50)
```
